...
export default async function Page({ params }: PageProps) {
  ...
  const [product, categories, craftTypes] = await Promise.all([
        ...
        <section className="mt-7 grid gap-6 lg:grid-cols-[minmax(0,1fr)_420px]">
          <div className="relative overflow-hidden rounded-[30px] border border-[#f0c3cf] bg-white p-6 shadow-[0_22px_60px_rgba(122,16,66,0.08)] md:p-9">
            ...
            <div className="relative max-w-4xl border-l-4 border-[#d99a00] pl-5 md:pl-7">
              ...
              <p className="mt-5 max-w-3xl text-lg leading-8 text-[#5b4a42] md:text-xl">
                Actualiza la foto, la historia, los materiales o el estado de publicación
                sin perder el valor cultural de tu vitrina.
              </p>
            </div>
          </div>
          ...
          <aside className="rounded-[30px] border border-[#ecd0bd] bg-[linear-gradient(145deg,#fff_0%,#fff7e8_100%)] p-6 shadow-[0_22px_60px_rgba(122,49,0,0.1)]">
            ...
            <p className="mt-3 text-sm leading-6 text-[#5b4a42]">
              Puedes publicar, pausar o devolver a borrador una pieza ya creada. Los
              cambios se reflejan en tu vitrina cuando guardas.
            </p>
            <div className="mt-6 space-y-3">
              {[
                ["Foto", "Cambia la imagen principal si tienes una mejor toma."],
                ["Historia", "Corrige o completa el relato cultural de la pieza."],
                ["Estado", "Controla si aparece publicada, pausada o en borrador."]
        ...
        <div className="mt-6">
          <ProductForm
            ...
            initialValue={{
              ...
              craftTypeId: product.craftTypeId,
              culturalPhrase: product.culturalPhrase ?? "",
              story: product.story ?? "",
              ...
              imageUrl: product.images[0]?.file.url ?? null
            }}
          />
        </div>
      </div>
